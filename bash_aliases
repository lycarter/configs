...
alias gb='gw build'
alias gwforward='gw cJ cTJ checkstyleMain checkstyleTest'
...
alias compileIntegration='gw compileJava compileTestJava compileIntegrationTestJava'
alias compile='gw compileJava compileTestJava'
